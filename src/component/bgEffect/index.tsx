...
import cloverUrl from "../../icons/clover.svg"

// 네잎클로버의 이동 및 회전 속도 설정
const X_SPEED = 0.6
...
class Petal {
   ...
   */
  initialize() {
    // 클로버는 정사각형 비율 유지 (꽃잎처럼 납작하지 않게)
    this.w = 20 + Math.random() * 16
    this.h = this.w
    this.opacity = 0.45 + this.w / 90
